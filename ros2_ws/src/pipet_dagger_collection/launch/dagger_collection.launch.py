...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('linear_step_mm', default_value='0.25'),
            DeclareLaunchArgument('angular_step_deg', default_value='0.25'),
            DeclareLaunchArgument('deadzone', default_value='0.22'),
            DeclareLaunchArgument('max_delta_mm', default_value='0.5'),
